...
export const HUD: React.FC = () => {
  ...
  // This prevents the alert from becoming huge (desktop size) on landscape mobile screens
  const alertDimensions = isMobile 
    ? "w-40 h-14" 
    : "w-40 h-14 md:w-1/3 md:max-w-md md:h-24";
  ...
  return (
    <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
      ...
      {isTargetingPlayer && (
          <div className={`absolute top-0 left-1/2 -translate-x-1/2 z-50 ${alertDimensions}`}>
